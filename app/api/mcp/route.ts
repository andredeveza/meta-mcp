...
const handler = createMcpHandler(
  (server) => {
    server.registerTool("consultar_cep", {
      title: "Consultar CEP",
    ...
    server.registerTool("consultar_cnpj", {
    ...
    server.registerTool("consultar_ddd", {
      title: "Consultar DDD",
    ...
    server.registerTool("listar_bancos", {
      title: "Listar bancos",
    ...
    server.registerTool("consultar_banco", {
    ...
    server.registerTool("consultar_fipe", {
      title: "Consultar FIPE",
      description: "Consulta preços FIPE usando um código FIPE já conhecido.",
    ...
    server.registerTool("consultar_ibge_uf", {
      title: "Consultar UF",
  ...
  },
  {
    ...
    instructions: "Ferramentas para consultar dados públicos brasileiros por meio da BrasilAPI.",
  },
);
